...
// 分页查询
func (this *Plate) Query(rs interface{}, page *common.Page, whr map[string]interface{}, order string) error {
	var total int
...
// 添加
func (this *Plate) Add() error {
	return common.DB.Create(this).Error
}

// 删除
func (this *Plate) Del() error {
	if this.Id == 0 {
		return MissPkErr
	}
...
// 更新
func (this *Plate) Update(whr map[string]interface{}) error {
	if this.Id == 0 {
		return MissPkErr
	}
	if whr == nil {
